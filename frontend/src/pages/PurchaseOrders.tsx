    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Manage inbound orders and restock inventory.</p>
        </div>
        <button 
                ...
                {orders?.length > 0 ? (
                  orders.map((order: any) => (
                    <tr key={order.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-900">{order.supplier_id}</td>
                      ...
                      <td className="px-6 py-4 text-sm text-right flex items-center justify-end gap-3">
                        <button 
                          onClick={() => {
